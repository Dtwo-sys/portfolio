...
<div class="not-prose my-8 flex justify-center">
  <figure class="max-w-xs w-full">
    <Image src={records} alt="WSPR Records card showing furthest received station KK4JI at 4316 miles and furthest transmitted station WA2TP at 3260 miles" class="w-full rounded-xl" widths={[400, 600]} sizes="(max-width: 480px) 100vw, 400px" />
